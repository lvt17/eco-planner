           ...
           {/* Card 2 */}
            <div className="group relative rounded-3xl overflow-hidden shadow-sm hover:shadow-xl transition-all duration-500 bg-[#E8E6E1] cursor-pointer">
               <div className="absolute inset-0 p-8 flex items-center justify-center">
                   <img src="https://images.unsplash.com/photo-1611250282006-e3c356f94793?q=80&w=1000&auto=format&fit=crop" className="w-[80%] h-auto object-contain transition-transform duration-500 group-hover:rotate-6 group-hover:scale-110" alt="Stickers" />
               </div>
